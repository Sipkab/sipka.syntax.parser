...
public class RuleFactory {
	...
	public Rule createInvokeRule(InvokeParam<?> ruleParam, String alias, List<InvokeParam<?>> invokeParams) {
		return returnRule(new InvokeRule(null, ruleParam, alias, invokeParams));
	}
